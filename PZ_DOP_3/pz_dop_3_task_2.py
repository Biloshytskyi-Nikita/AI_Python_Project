...
coefficients = {'a': 2, 'b': 0, 'c': 2, 'd': 3, 'e': 1, 'f': 0}
...
class PolynomialModel(nn.Module):
    def init(self):
        super(PolynomialModel, self).init()
...
# Збереження навченої моделі у файлі
...
class NonlinearModel(nn.Module):
    def init(self):
        super(NonlinearModel, self).init()
